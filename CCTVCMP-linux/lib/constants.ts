...
export const routeRoleMap: Record<string, Role[]> = {
  ...
  "/mobile-machine": [Role.admin, Role.project_manager, Role.safety_officer, Role.viewer],
  ...
  "/api/edge-devices": [Role.admin, Role.project_manager, Role.safety_officer, Role.viewer],
  ...
  "/api/dashboard": [Role.admin, Role.project_manager, Role.safety_officer, Role.viewer],
};
